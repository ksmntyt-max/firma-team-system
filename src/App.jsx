      ...
      <div className="sidebar">
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            {user.picture
              ? <img src={user.picture} className="sidebar-avatar-img" alt="" referrerPolicy="no-referrer" />
              : <div className="sidebar-avatar-init" style={{ background: '#FF855C' }}>{initials(user.name)}</div>
            }
